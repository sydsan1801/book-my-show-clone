...
// Function to display image and child of EntertainmentCardSlider
...
const EntertainmentCardSlider=()=>{
  ...
  const settings={
    ...
    slidesToShow:5,
    slidesToScroll:4,
    // First slide to be displayed as the initial slide
    intialSlide:0,
    responsive:[
      // large screen size
       {
  ...
  return (
    <>
    {/* Map with array(iterate the arary) and call EntertainmentCard and pass src of image*/}
    <Slider {...settings}>{EntertainmentImage.map((image , index)=><EntertainmentCard src={image} key={index}/>)}</Slider>
